...
export function WhatsAppButton() {
  const phoneNumber = "5491163597667"; // Replace with real number if provided, or keep generic for now
  const message = encodeURIComponent("Hola! los contacto desde su pagina web ya que quisiera obtener m\u00e1s informaci\u00f3n sobre los productos MINIT.");
