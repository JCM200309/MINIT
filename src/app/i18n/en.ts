export const en = {
  ...
  "howItWorks.step3.desc": "When exposed to heat, the retardant creates an insulating barrier that <strong>prevents ignition and stops the spread of flames</strong> by depriving it of oxygen.",
